...
const activePersonaLabel =
  "bg-[#f0f4ff] text-[#1354ec] dark:bg-primary/20 dark:text-primary";

const inactivePersonaLabel =
  "text-gray-500 hover:text-gray-900 transition-all dark:text-slate-400 dark:hover:text-slate-100";
      ...
      <div className="w-full max-w-[1200px] grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        <div className="flex flex-col gap-8 lg:sticky lg:top-32 pt-4">
          ...
          <div className="space-y-4">
            <h1 className="text-[#0d121b] text-4xl md:text-5xl lg:text-[56px] font-black leading-[1.1] tracking-[-0.02em] dark:text-slate-100">
              {content.headline[0]} <br className="hidden lg:block" />
              {content.headline[1]}
            </h1>
            <p className="text-[#4c639a] text-lg md:text-xl font-normal leading-relaxed max-w-[540px] dark:text-slate-400">
              {content.subheadline}
            </p>
          </div>
          <div className="flex flex-col gap-4 mt-4">
            <div className="flex items-center gap-3 text-[#4c639a] dark:text-slate-400">
          ...
          <div className="pt-8 border-t border-[#e7ebf3] mt-4 dark:border-navy-700">
            <p className="text-xs font-semibold uppercase tracking-wider text-[#9ca3af] mb-4 dark:text-slate-500">
              Trusted by modern teams
            </p>
            <div className="flex gap-6 opacity-60 grayscale items-center flex-wrap">
              <div className="h-6 font-bold text-lg text-gray-500 flex items-center gap-1 dark:text-slate-500">
        ...
        <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#e7ebf3] p-6 md:p-8 lg:p-10 w-full max-w-[520px] mx-auto lg:mx-0 dark:bg-navy-800 dark:border-navy-700">
          <div className="mb-8">
            ...
            <p className="text-[#4c639a] text-sm dark:text-slate-400">
          ...
          <form className="flex flex-col gap-5">
            ...
            <div className="space-y-1.5">
              <label
                className="text-[#0d121b] text-sm font-semibold dark:text-slate-300"
                htmlFor="fullname"
              >
                Full Name
              </label>
              <input
                className="w-full h-12 rounded-xl border border-[#cfd6e7] bg-[#f8f9fc] px-4 text-base text-[#0d121b] focus:border-[#1354ec] focus:ring-1 focus:ring-[#1354ec] focus:outline-none transition-all placeholder:text-[#9ca3af] dark:border-navy-700 dark:bg-navy-900 dark:text-slate-100 dark:focus:border-primary dark:focus:ring-primary dark:placeholder:text-slate-500"
                id="fullname"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select
                    className="w-full h-12 rounded-xl border border-[#cfd6e7] bg-[#f8f9fc] px-4 text-base text-[#0d121b] focus:border-[#1354ec] focus:ring-1 focus:ring-[#1354ec] focus:outline-none transition-all appearance-none cursor-pointer dark:border-navy-700 dark:bg-navy-900 dark:text-slate-100 dark:focus:border-primary dark:focus:ring-primary"
                    id="role"
                    value={role}
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center px-4 pointer-events-none text-[#4c639a] dark:text-slate-400">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                className="w-full rounded-xl border border-[#cfd6e7] bg-[#f8f9fc] p-4 text-base text-[#0d121b] focus:border-[#1354ec] focus:ring-1 focus:ring-[#1354ec] focus:outline-none transition-all resize-none placeholder:text-[#9ca3af] dark:border-navy-700 dark:bg-navy-900 dark:text-slate-100 dark:focus:border-primary dark:focus:ring-primary dark:placeholder:text-slate-500"
                id="message"
