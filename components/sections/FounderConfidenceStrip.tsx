      ...
      <section className="py-24 bg-background-light dark:bg-navy-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/request-demo?persona=founder"
              className="w-full sm:w-auto bg-primary hover:bg-primary-hover text-white text-lg font-bold h-14 px-10 rounded-xl transition-all shadow-xl shadow-primary/30 dark:shadow-primary/40 inline-flex items-center justify-center"
            >
              Get Started Now
            </Link>
            <Link
              href="/for-finance"
              className="w-full sm:w-auto bg-transparent border border-slate-200 text-slate-900 hover:bg-white text-lg font-bold h-14 px-10 rounded-xl transition-all dark:border-navy-700 dark:text-slate-100 dark:hover:bg-navy-800 inline-flex items-center justify-center"
            >
              Talk to Sales
            </Link>
          </div>
